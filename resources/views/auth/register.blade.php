                        ...
                        <div class="form-row mt-2">
                            ...
                            <div class="col-12 col-md-6"> 
                                    ...
                                    <div class="form-check">
                                        ...
                                        name="gender_id" value="{{$gender->id}}"  {{(old('gender_id') == $gender->id ) ? "checked" : null }} >
                          ...
                          <div class="form-row">
                            ...
                            <div class="col-12 col-md-6"> 
                                ...
                                <option value="{{ $occupation->id }}" @if(old('occupation_id') ==  $occupation->id) ? 'selected' : "" @endif>
                          ...
                          <div class="col-12 col-md-6">
                            ...
                            <select class="form-control {{ $errors->has('family_type_id') ? 'is-invalid' : '' }} form-control-solid"
                              ...
                              <option value="{{ $family_type->id }}" @if(old('family_type_id') ==  $family_type->id) ? 'selected' : "" @endif>
