    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                <div class="card-title h5 ">Basic Details</div><hr>
                      ...
                      @csrf
                        ...
                        <div class="form-row mt-2">
                            ...
                            <div class="col-12 col-md-6"> 
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input @error('gender_id') is-invalid @enderror" type="radio"
                                        name="gender_id" value="{{$gender->id}}"  
                                        {{(old('gender_id') == $gender->id ) ? "checked" : null }}
                                        {{($user->gender_id == $gender->id ) ? "checked" : null }} >
                          ...
                          <div class="form-row">
                            ...
                            <div class="col-12 col-md-6"> 
                                ...
                                <select class="form-control {{ $errors->has('occupation_id') ? 'is-invalid' : '' }} form-control-solid"
                          ...
                          <div class="col-12 col-md-6">
                            ...
                            <select class="form-control {{ $errors->has('family_type_id') ? 'is-invalid' : '' }} form-control-solid"
                              name="family_type_id" required="required">
                              <option value="">Select</option>
                              @foreach ($family_types as $family_type)
                              <option value="{{ $family_type->id }}" {{old('family_type_id') ==  $family_type->id ? 'selected' : "" }} 
                                {{($user->family_type_id ==  $family_type->id) ? 'selected' : ""}}>
                          ...
                          <div class="col-12 col-md-6">
                            ...
                            <select class="form-control {{ $errors->has('manglik') ? 'is-invalid' : '' }} form-control-solid"
                              name="manglik" required="required">
                              <option value="">Select </option>
                              <option value="Yes" {{old('manglik') ==  'Yes' ? 'selected' : "" }} 
                                {{($user->manglik == 'Yes') ? 'selected' : ""}}>Yes</option>
                              <option value="No" {{old('manglik') ==  'No' ? 'selected' : "" }} 
                                {{($user->manglik == 'No') ? 'selected' : ""}}>No</option>
                            </select>
                            <div class="invalid-feedback">{{ $errors->first('manglik') }}</div>
                          </div>
                        </div>
                        <div class="card-title mt-5 h5">Partner Preference Details</div><hr>
                        <div class="row">
                            <div class="col-12 col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select class="form-control {{ $errors->has('manglik_preference') ? 'is-invalid' : '' }} form-control-solid"
                                  name="manglik_preference" required="required">
                                  <option value="">Select </option>
